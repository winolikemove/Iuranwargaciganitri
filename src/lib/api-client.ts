  ...
  return {
    ...
    agendas: [
      ...
      },
      {
        ...
        startDate: dates.formatDate(rapatDate.getFullYear(), rapatDate.getMonth(), rapatDate.getDate() + 3),
        startTime: '09:00',
        endDate: dates.formatDate(rapatDate.getFullYear(), rapatDate.getMonth(), rapatDate.getDate() + 3),
        endTime: '11:00',
        status: 'UPCOMING',
        targetBlok: 'all',
        createdBy: 'Ibu Siti',
        createdAt: dates.formatDateTime(dates.year, dates.month, 3),
        updatedAt: dates.formatDateTime(dates.year, dates.month, 3),
      },
      {
        id: '4',
        ...
        startDate: dates.formatDate(rapatDate.getFullYear(), rapatDate.getMonth(), rapatDate.getDate() + 5),
        startTime: '15:00',
        endDate: dates.formatDate(rapatDate.getFullYear(), rapatDate.getMonth(), rapatDate.getDate() + 6),
        endTime: '18:00',
        status: 'UPCOMING',
        targetBlok: 'all',
        createdBy: 'Sie. Olahraga',
        createdAt: dates.formatDateTime(dates.year, dates.month, 4),
        updatedAt: dates.formatDateTime(dates.year, dates.month, 4),
      },
      {
        id: '5',
        ...
        startDate: dates.formatDate(rapatDate.getFullYear(), rapatDate.getMonth(), rapatDate.getDate() + 10),
        startTime: '08:00',
        endDate: dates.formatDate(rapatDate.getFullYear(), rapatDate.getMonth(), rapatDate.getDate() + 10),
        endTime: '12:00',
        status: 'UPCOMING',
        targetBlok: 'all',
        createdBy: 'Admin',
        createdAt: dates.formatDateTime(dates.year, dates.month, 5),
        updatedAt: dates.formatDateTime(dates.year, dates.month, 5),
      },
    ] as Agenda[],
    ...
    galleries: [
      {
        id: '1',
        title: 'Kerja Bakti Bersih Lingkungan',
        description: 'Kegiatan gotong royong bersih-bersih komplek yang diikuti warga blok A dan B',
        imageUrl: 'https://images.unsplash.com/photo-1593113630400-ea4288922497?w=800',
        thumbnailUrl: 'https://images.unsplash.com/photo-1593113630400-ea4288922497?w=400',
        agendaId: null,
      ...
      },
      {
        ...
        thumbnailUrl: 'https://images.unsplash.com/photo-1609599006353-e629aaabfeae?w=400',
        agendaId: null,
        takenAt: dates.formatDateTime(dates.year, dates.month, 12),
        uploadedBy: 'Admin',
        createdAt: dates.formatDateTime(dates.year, dates.month, 12),
      },
      {
        id: '3',
        title: 'Rapat Koordinasi Pengurus RT',
        description: 'Rapat rutin pengurus RT membahas program kerja dan keuangan',
        imageUrl: 'https://images.unsplash.com/photo-1531497865144-0464ef8fb9a9?w=800',
        thumbnailUrl: 'https://images.unsplash.com/photo-1531497865144-0464ef8fb9a9?w=400',
        agendaId: null,
        takenAt: dates.formatDateTime(dates.year, dates.month, 10),
        uploadedBy: 'Admin',
        createdAt: dates.formatDateTime(dates.year, dates.month, 10),
      },
      {
        id: '4',
        ...
        agendaId: null,
        takenAt: dates.formatDateTime(dates.year, dates.month, 8),
        uploadedBy: 'Admin',
        createdAt: dates.formatDateTime(dates.year, dates.month, 8),
      },
      {
        id: '5',
        ...
        agendaId: null,
        takenAt: dates.formatDateTime(dates.year, dates.month, 5),
        uploadedBy: 'Admin',
        createdAt: dates.formatDateTime(dates.year, dates.month, 5),
      },
      {
        ...
        agendaId: null,
        takenAt: dates.formatDateTime(dates.year, dates.month - 1, 28),
        uploadedBy: 'Admin',
        createdAt: dates.formatDateTime(dates.year, dates.month - 1, 28),
      },
      {
        id: '7',
        title: 'Bakti Sosial Warga',
        description: 'Kegiatan bakti sosial dan pembagian sembako untuk warga',
        ...
        agendaId: null,
        takenAt: dates.formatDateTime(dates.year, dates.month - 1, 25),
        uploadedBy: 'Admin',
        createdAt: dates.formatDateTime(dates.year, dates.month - 1, 25),
      },
      {
        id: '8',
        title: 'Pelatihan Digital Lansia',
        ...
        agendaId: null,
        takenAt: dates.formatDateTime(dates.year, dates.month - 1, 20),
        uploadedBy: 'Admin',
        createdAt: dates.formatDateTime(dates.year, dates.month - 1, 20),
      },
      {
        id: '9',
        title: 'Posyandu Balita',
        description: 'Kegiatan posyandu balita bersama kader kesehatan',
        imageUrl: 'https://images.unsplash.com/photo-1587854692152-cbe660dbde88?w=800',
        thumbnailUrl: 'https://images.unsplash.com/photo-1587854692152-cbe660dbde88?w=400',
        agendaId: null,
        takenAt: dates.formatDateTime(dates.year, dates.month - 1, 15),
        uploadedBy: 'Admin',
        createdAt: dates.formatDateTime(dates.year, dates.month - 1, 15),
      },
      {
        id: '10',
        ...
        agendaId: null,
        takenAt: dates.formatDateTime(dates.year, dates.month - 1, 10),
        uploadedBy: 'Admin',
        createdAt: dates.formatDateTime(dates.year, dates.month - 1, 10),
      },
    ] as Gallery[],
    ...
    reviews: [
      ...
      },
      {
        ...
        status: 'APPROVED',
        createdAt: dates.formatDateTime(dates.year, dates.month, 22, 10),
      },
      {
        id: '3',
        userId: 'user3',
        ...
        status: 'APPROVED',
        createdAt: dates.formatDateTime(dates.year, dates.month, 18, 14),
      },
      {
        id: '4',
        userId: 'user4',
        ...
        status: 'APPROVED',
        createdAt: dates.formatDateTime(dates.year, dates.month, 15, 9),
      },
      {
        id: '5',
        userId: 'user5',
        ...
        status: 'APPROVED',
        createdAt: dates.formatDateTime(dates.year, dates.month, 10, 11),
      },
    ] as Review[],
...
class ApiClient {
  ...
  private async handleDemoRequest<T>(
    ...
    switch (action) {
      ...
      case 'finance.summary': {
        ...
        // Get year and month from payload or use defaults
        const filterYear = payload.year ? parseInt(payload.year as string) : financeNow.getFullYear();
        const filterMonth = payload.month ? parseInt(payload.month as string) : null;
        
        // Generate demo values based on filters
        const baseIncome = blok === 'A' ? 4500000 : 3200000;
        const baseExpense = blok === 'A' ? 2500000 : 1800000;
        const baseSaldoAwal = blok === 'A' ? 1500000 : 800000;
        
        // Calculate total for the filtered period
        let totalPemasukan = baseIncome;
        let totalPengeluaran = baseExpense;
        
        // If filtering by specific month, adjust values
        if (filterMonth) {
          totalPemasukan = Math.floor(baseIncome / 3 + Math.random() * 500000);
          totalPengeluaran = Math.floor(baseExpense / 3 + Math.random() * 300000);
        }
        ...
        for (let m = 0; m < 12; m++) {
          ...
          if (filterYear === financeNow.getFullYear() && monthNum > financeNow.getMonth() + 1) continue;
          
          const pemasukan = Math.floor(Math.random() * 2000000) + 1500000;
          const pengeluaran = Math.floor(Math.random() * 1500000) + 800000;
          monthlyBreakdown.push({
            month: `${finMonthNames[monthNum]} ${filterYear}`,
            monthShort: finMonthShort[monthNum],
            pemasukan,
            pengeluaran,
            saldo: 0,
          });
        ...
        const periodLabel = filterMonth 
          ? `${finMonthNames[filterMonth]} ${filterYear}`
          : `Tahun ${filterYear}`;
        
        result = { 
          ok: true, 
          data: {
            saldoAwal: baseSaldoAwal,
            totalPemasukan,
            totalPengeluaran,
            saldoAkhir: baseSaldoAwal + totalPemasukan - totalPengeluaran,
            periodLabel,
            blok: blok,
            monthlyBreakdown,
          } as T 
      ...
      case 'finance.transactions': {
        ...
        const currentYear = txNow.getFullYear();
        const currentMonth = txNow.getMonth();
        
        // Generate transactions for multiple months (current year and previous year for testing)
        const allDemoTransactions: Transaction[] = [];
        let txId = 1;
        
        // Generate transactions for the past 12 months
        for (let monthOffset = 0; monthOffset < 12; monthOffset++) {
          const txMonth = currentMonth - monthOffset;
          const txYear = currentYear + Math.floor(txMonth / 12);
          const normalizedMonth = ((txMonth % 12) + 12) % 12;
          
          // Income transactions for this month
          allDemoTransactions.push({
            id: `tx-${txId++}`,
            blok: txBlok,
            type: 'INCOME',
            category: 'Iuran Bulanan',
            amount: 450000 + Math.floor(Math.random() * 200000),
            description: 'Iuran bulanan dari warga Blok ' + txBlok,
            date: new Date(txYear, normalizedMonth, 5).toISOString(),
            createdBy: 'bendahara',
            createdAt: new Date(txYear, normalizedMonth, 5).toISOString(),
          });
          ...
          allDemoTransactions.push({
            ...
            date: new Date(txYear, normalizedMonth, 8).toISOString(),
            createdBy: 'admin',
            createdAt: new Date(txYear, normalizedMonth, 8).toISOString(),
          });
          ...
          allDemoTransactions.push({
            ...
            type: 'EXPENSE',
            category: 'Kebersihan',
            amount: 300000 + Math.floor(Math.random() * 100000),
            description: 'Pembelian alat kebersihan dan upah petugas',
            date: new Date(txYear, normalizedMonth, 10).toISOString(),
            createdBy: 'admin',
            createdAt: new Date(txYear, normalizedMonth, 10).toISOString(),
          });
          ...
          allDemoTransactions.push({
            ...
            date: new Date(txYear, normalizedMonth, 15).toISOString(),
            createdBy: 'admin',
            createdAt: new Date(txYear, normalizedMonth, 15).toISOString(),
          });
          
          if (normalizedMonth % 3 === 0) { // Every 3 months
            allDemoTransactions.push({
              id: `tx-${txId++}`,
              blok: txBlok,
              type: 'EXPENSE',
              category: 'Perbaikan',
              amount: 200000 + Math.floor(Math.random() * 150000),
              description: 'Perbaikan fasilitas umum',
              date: new Date(txYear, normalizedMonth, 20).toISOString(),
              createdBy: 'admin',
              createdAt: new Date(txYear, normalizedMonth, 20).toISOString(),
            });
          }
        }
        
        // Apply filters from payload
        let filteredTransactions = allDemoTransactions;
        
        // Filter by year
        if (payload.year) {
          const filterYear = parseInt(payload.year as string);
        ...
        // Filter by month
        if (payload.month) {
          const filterMonth = parseInt(payload.month as string);
          filteredTransactions = filteredTransactions.filter(t => {
            const txDate = new Date(t.date);
            return (txDate.getMonth() + 1) === filterMonth;
          });
        }
        
        // Filter by type
        if (payload.type) {
          filteredTransactions = filteredTransactions.filter(t => t.type === payload.type);
        }
        ...
        result = { ok: true, data: filteredTransactions as T };
        break;
      }
  ...
  async getFinanceSummary(year?: number, month?: number, blok?: string): Promise<ApiResponse<FinanceSummary>> {
    return this.request<FinanceSummary>('finance.summary', { year, month, blok }, {
      useCache: true,
      cacheKey: `finance_summary_${year || 'current'}_${month || 'all'}_${blok || 'default'}`,
      cacheTTL: 60 * 1000,
    });
  }
  
  async getTransactions(filters?: { year?: number; month?: number; type?: string; limit?: number; blok?: string }): Promise<ApiResponse<Transaction[]>> {
